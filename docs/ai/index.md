...
MethodAtlas can optionally send each parsed test class to an AI provider for security classification. This section explains how the AI subsystem works, what data is transmitted, and how to choose the right provider for your environment.
...
| Auto | `auto` | Ollama first, then fallback | Depends | Depends |
